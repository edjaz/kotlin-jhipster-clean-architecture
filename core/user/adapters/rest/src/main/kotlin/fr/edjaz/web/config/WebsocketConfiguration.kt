...
class WebsocketConfiguration(private val jHipsterProperties: JHipsterProperties) : AbstractWebSocketMessageBrokerConfigurer() {
    ...
    override fun registerStompEndpoints(registry: StompEndpointRegistry) {
        val allowedOrigins = Optional.ofNullable(jHipsterProperties.cors.allowedOrigins).map { origins -> origins.toTypedArray() }.orElse(arrayOfNulls(0))
