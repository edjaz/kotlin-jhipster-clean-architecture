...
object PaginationUtil {
    ...
    fun generateSearchPaginationHttpHeaders(query: String, page: Page<*>, baseUrl: String): HttpHeaders {
        ...
        var link = ""
        if (page.number + 1 < page.totalPages) {
            link = "<" + generateUri(baseUrl, page.number + 1, page.size) + "&query=" + escapedQuery + ">; rel=\"next\","
        }
        // prev link
        if (page.number > 0) {
